<div class="hamburger" onclick="rahuz()"><svg id="hambi" xmlns="http://www.w3.org/2000/svg" width="40" height="40"
        viewBox="0 0 24 24">
...
<ul class="nav-horgonyok">
    ...
    <li class="dropdown"><a href="valaszto.php" class="dropdown-button">Árlista <svg xmlns="http://www.w3.org/2000/svg"
    ...
    <li><a href="crud/login.php">ADMIN Felület</a></li>
</ul>